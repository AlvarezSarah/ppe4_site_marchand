...
class AdminMagasinController extends AbstractController {
    ...
    /**
     * @route("/admin/magasin", name = "admin.magasin.index")
    ...
    /**
     * @Route("/admin/magasin/create", name="admin.magasin.new")
    ...
    /**
     * @Route("/admin/magasin/{id}", name="admin.magasin.edit", methods="GET|POST")
     * @param Magasin $magasin
    ...
    /**
     * @Route("/admin/magasin/{id}", name="admin.magasin.delete", methods="DELETE")
     * @param Magasin $magasin
